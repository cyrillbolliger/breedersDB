...
<div class="marks form large-9 medium-8 columns content">
    ...
    ?>
    <?php // close form before list of marks, else the post link (delete) of the first mark value breaks ?>
    <?= $this->Form->end() ?>
    ...
    <button onclick="document.edit_mark_form.submit()" type="submit"><?= __('Submit') ?></button>
</div>
