<ul class="side-nav">
    ...
    <li><?= $this->Html->link(__('Mark Tree (Scanner)'), ['controller' => 'Marks', 'action' => 'addTreeMarkByScanner']) ?></li>
    ...
    <li><?= $this->Html->link(__('New Property'), ['controller' => 'MarkFormProperties', 'action' => 'add']) ?></li>
    <li><?= $this->Html->link(__('List Properties'), ['controller' => 'MarkFormProperties', 'action' => 'index']) ?></li>
    <li>&nbsp;</li>
    ...
    <li><?= $this->Html->link(__('Print submit form label'), ['controller' => 'MarkScannerCodes', 'action' => 'printSubmit']) ?>
    </li>
</ul>
