...
/**
 * handels all the generall stuff
 */
function General() {

     /**
      * having our class alway accessible can get handy
      */
     var self = this;
...
/**
 * handels all the varieties stuff
 */
function Varieties() {
...
function Marks() {
     ...
     /**
      * Instatiate actions for newly added fields (applied to all fields)
      */
