...
$empty_marks = [96,97,98,99,100,101,102,103,104,105,106,107,109,112,179,263,323,324,325,326,327,328,338,396,403,407,457,482,520,584,601,604,655,658,659,661,662,664,666,674,685,688,716,745,749,750,769,775,787,825,865,866,869,870,875,932,940,952,978,1053,1070,1078,1282,1288,1328,1464,1465,1470,1484,1486,1531,1532,1533,1580,1660,1723,1772,1785,1787,1800,1812,1813,1818,1819,1820,1848,1868,1892,2101,2288,2290,2325,2337,2348,2349,2350,2352,2353,2356,2367,2506,2507,2510,2516,2517,2525,2526,2529,2540,2542,2543,2545,2553,2555,2556,2558,2560,2563,2568,2571,2573,2584,2585,2599,2600,2619,2624,2671,2687,2694,2695,2696,2700,2718,2727,2756,2767,2805,2816,2837,2857,2866,2868,2872,2880,2881,2905,2915,2919,2932,2936,2937,2938,2939,2940,2941,2942,2943,2945,2949,2951,2957,2960,2964,2969,2971,2972,2973,2974,2979,2980,2997,3034,3038,3055,3061,3064,3090,3151,3157,3162,3165,3179,3181,3185,3186,3223,3227,3230,3241,3251,3260,3283,3297,3301,3302,3312,3315,2874];
...
//move('Kreuzungen','mother_trees'); // don't move! we have to start clean here
move('Baeume','trees');
move('Lose','batches');
move('Klon', 'varieties');
move('Reihen', 'rows');
...
function trees($oldtbl, $newtbl, $old, $new) {
    ...
    foreach ($data as $key => $d) {
        ...
        // remove missing rows
        if (in_array($d['row_id'], $missing_rows)) {
            $data[$key]['row_id'] = null;
        }
