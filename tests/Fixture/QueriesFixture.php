...
class QueriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'query' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-07-22 17:43:39',
            'modified' => '2017-07-22 17:43:39'
        ],
    ];
}
