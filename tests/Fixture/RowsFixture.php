...
class RowsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'date_eliminated' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'date_created' => '2017-01-17 16:30:05',
            'date_eliminated' => 'Lorem ipsum dolor sit amet',
            'deleted' => 1,
            'locked' => 1,
            'created' => '2017-01-17 16:30:05',
            'modified' => '2017-01-17 16:30:05'
        ],
    ];
}
