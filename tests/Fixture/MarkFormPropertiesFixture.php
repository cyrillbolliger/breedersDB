...
class MarkFormPropertiesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'validation_rule' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'field_type' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'mark_form_property_type_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'validation_rule' => 'Lorem ipsum dolor sit amet',
            'field_type' => 'Lorem ipsum dolor sit amet',
            'mark_form_property_type_id' => 1,
            'created' => '2017-01-18 14:49:17',
            'modified' => '2017-01-18 14:49:17'
        ],
    ];
}
